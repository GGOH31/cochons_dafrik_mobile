      ...
      try {
        ...
        if (_selectedRole == "vendeur") {
          shopRequest = StoreShopRequest(
            ...
            description: _shopDescriptionController.text.trim().isEmpty ? null : _shopDescriptionController.text.trim(),
            commune: _shopCommuneController.text.trim(),
            address: _shopAddressController.text.trim().isEmpty ? null : _shopAddressController.text.trim(),
        ...
        if (mounted) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => OtpPage(phoneNumber: _phoneController.text.trim()),
            ),
          );
        }
      } catch (e) {
